...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="<?php echo isset($_SESSION['user_id']) ? 'visitor_reservation.php' : 'login.php'; ?>">Reservasi Kunjungan</a></li>
            <li><a href="<?php echo isset($_SESSION['user_id']) ? 'e_resources.php' : 'login.php'; ?>">E-Resources</a></li>
